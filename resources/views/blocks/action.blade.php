            ...
            <div class="col-xs-24">
                <div class="page-prev">
                    <a href="#" class="page-prev__link js-back">
                        ...
                        <span class="page-prev__text">Назад</span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row-fluid">
        <article role="article" class="content-block clearfix">
            <div class="sidebar col-xs-24 col-sm-8">
                ...
                <div class="sidebar__item">
                    <div class="thumb">
                        <ul class="thumb__list list-unstyled list-inline">
                            <li class="thumb__item">
                                <a href="" class="thumb__link">
                                    <img src="img/temp/temp_photo-2.jpg"alt="" class="photo__img">
                                </a>
                            </li>
                            <li class="thumb__item">
                                <a href="" class="thumb__link">
            ...
            <div class="col-xs-24 col-sm-16">
                <div class="content-block__heading">
                    <h1>Скидка 20% на все средства по уходу за волосами Gliss Kur</h1>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-24">
                            <h3 class="more-info__heading">
                                Адреса проведения акции <span class="more-info__heading--num">(15)</span>
                            </h3>
                            <div class="more-info__address more-info__address--height js-store-list">
                                    ...
                                    <div class="col-xs-24 col-sm-12">
                                        ...
                                        <ul class="more-info__list">
                                            <li class="more-info__item">
                                                <a href="" class="more-info__link">г.Саратов, ул.Яблочкова, 1/35</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-xs-24 col-sm-12">
                                        ...
                                        <ul class="more-info__list">
                                            <li class="more-info__item">
                                                <a href="" class="more-info__link">г.Саратов, ул.Зарубина, 167</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-24 col-sm-12">
                                        ...
                                        <ul class="more-info__list">
                                            <li class="more-info__item">
                                                <a href="" class="more-info__link">г.Саратов, ул.Астраханская, 140</a>
                                            </li>
                                            <li class="more-info__item">
                                                <a href="" class="more-info__link">г.Саратов, ул.Московская, 152</a>
                                            </li>
                                            <li class="more-info__item">
                                                <a href="" class="more-info__link">г.Саратов, Привокзальная пл., 31</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-xs-24 col-sm-12">
                            ...
                            <div class="col-xs-24">
                                <div class="more-info__maps">
                                    <div class="row">
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1240.6765174374657!2d46.013885715595016!3d51.54342517201501!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4114c7cb7553b5f3%3A0x62740cd8aa8df48f!2z0JDRgdGC0YDQsNGF0LDQvdGB0LrQsNGPINGD0LsuLCAxNDAsINCh0LDRgNCw0YLQvtCyLCDQodCw0YDQsNGC0L7QstGB0LrQsNGPINC-0LHQuy4sIDQxMDAwNQ!5e0!3m2!1sru!2sru!4v1445439087015" width="100%" height="200" frameborder="0" style="border:0" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section class="more-info clearfix">
                    ...
                    <div class="comment clearfix">
                        ...
                        <div class="comment__content">
                            ...
                            <p class="comment__text">Все достаточно аскетично, не смотря на стоимость товара и его рентабельность.</p>
                    ...
                    <div class="comment clearfix">
                        ...
                        <div class="comment__content">
                            ...
                            <p class="comment__text">Я так обычно медикам говорю в пограничном отделении диспансера, меня отпускают, но окно закрыто, выйти не могу...</p>
                            <a href="" class="comment__call-back">Ответить</a>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <form class="comment-add clearfix">
                        <div class="row">
                            <div class="col-xs-24">
                                <p>
                                    <textarea name="comment-text" id=""class="form-control comment-add__textarea" placeholder="Комментировать.."></textarea>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                ...
                <section class="more-info">
                    <h4 class="more-info__heading">Похожие акции <span class="more-info__heading--num">(3)</span></h4>
                    <div class="owl-carousel carousel">
                        <div class="owl-item-block">
                            <a href="offer.html" title="">
                                <img src="img/temp/temp_photo-1.jpg" class="owl-images" alt="">
                            </a>
                            <a href="offer.html" title="" class="more-info__heading--like">Скидка 20% на все средства по уходу за волосами Gliss Kur</span>
                            </a>
                        </div>
                        <div class="owl-item-block">
                            <a href="offer.html" title="">
                                <img src="img/temp/temp_photo-2.jpg" class="owl-images" alt="">
                            </a>
                            <a href="offer.html" title="" class="more-info__heading--like">Компания Purina приготовила подарки для собак</span>
                            </a>
                        </div>
                        <div class="owl-item-block">
                            <a href="offer.html" title="">
