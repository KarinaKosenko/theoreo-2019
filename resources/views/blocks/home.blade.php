        ...
        <article role="article" class="content-block clearfix">
            <div class="sidebar col-xs-24 col-sm-10">
                <div class="sidebar__item">
                    <a href="/action/" title="Скидка 20% на все средства по уходу за волосами Gliss Kur">
                        <div class="sidebar__img">
                            <img src="{{asset('img/temp/temp_photo-1.jpg')}}" alt="" class="img-responsive">
                        </div>
                    </a>
                </div>
                <div class="sidebar__item">
        ...
        <article role="article" class="content-block clearfix">
            ...
            <div class="sidebar col-xs-24 col-sm-10">
                <div class="sidebar__item">
                    <a href="/action/" title="Скидка 20% на все средства по уходу за волосами Gliss Kur">
                        <div class="sidebar__img">
                            <img src="{{asset('img/temp/temp_photo-2.jpg')}}" alt="" class="img-responsive">
                        </div>
                    </a>
                </div>
                <div class="sidebar__item">
        ...
        <article role="article" class="content-block clearfix">
            ...
            <div class="sidebar col-xs-24 col-sm-10">
                <div class="sidebar__item">
                    <a href="/action/" title="Скидка 20% на все средства по уходу за волосами Gliss Kur">
                        <div class="sidebar__img">
                            <img src="{{asset('img/temp/temp_photo-1.jpg')}}" alt="" class="img-responsive grayscale">
                        </div>
                    </a>
                </div>
                <div class="sidebar__item">
            ...
            <div class="col-xs-24 col-sm-14">
                ...
                <a role="link" href="/action/" class="content-block__heading content-block__heading--close">
                    <h2>Компания Purina приготовила подарки для собак</h2>
                </a>
                <p class="content-block__introtext">При покупке Pro Plan Dog 14кг - гамак для перевозки собак в авто в подарок.</p>
                <p class="content-block__date">Срок проведения: 13.05.2015-04.06.2015</p>
