...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Добавление бренда</h3>
    </div>
        ...
        <div class="box-body">
            ...
            <div class="form-group has-error">
             ...
             <div class="form-group">
                ...
                >
                    <option disabled selected value="">Выберете тип бренда</option>
                ...
                @endif
                     <input type="text" class="form-control"
                            id="phone" name="phone"
                            placeholder="+7-XXX-XXX-XX-XX, 8-(XXXX)-XXX-XXX"
                            value="{{old('phone')}}"
                     >
                     </div>
