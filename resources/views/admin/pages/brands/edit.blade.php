...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Редактирование "{{$brand->name}}"</h3>
    </div>
        ...
        <div class="box-body">
            ...
            <div class="form-group has-error">
             ...
             <div class="form-group">
                ...
                >
                    @if(old('name',$brand->name) == 'federal_brand')
                    <option value="federal_brand" selected>Федеральный бренд</option>
                    <option value="internet_shop">Интернет-магазин</option>
                    @else
                        <option value="federal_brand">Федеральный бренд</option>
                        <option value="internet_shop" >Интернет-магазин</option>
                    @endif
                </select>
            </div>
                ...
                @endif
                    <input type="text" class="form-control" id="sell_address"
                           name="sell_address" placeholder="Введите адрес компании"
                ...
                @if ($errors->has('categories'))
                    <div class="form-group has-error">
                    <label for="sell_address">Категории* ({{$errors->first('categories')}})</label><br>
                @else
                    <div class="form-group">
             ...
             @if ($errors->has('logo'))
                <div class="form-group has-error">
                <label for="img">Логотип бренда ({{$errors->first('img')}})</label>
            @else
                <div class="form-group">
                <label for="img">Логотип бренда</label>
            @endif
                ...
                >
                    <img src="{{old('img',$brand->img)}}" id="logo">
